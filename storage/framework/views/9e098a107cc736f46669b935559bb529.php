...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="zip_postal_code"
                           value="<?php echo e(old('zip_postal_code')); ?>"
                           class="w-full border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="locality_house_no"
                           value="<?php echo e(old('locality_house_no')); ?>"
                           class="w-full border-gray-300 rounded-md">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="city_district_town"
                           value="<?php echo e(old('city_district_town')); ?>"
                           class="w-full border-gray-300 rounded-md">
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="user_type" class="w-full border-gray-300 rounded-md">
                        <option value="user" <?php echo e(old('user_type')=='user'?'selected':''); ?>>User</option>
                        <option value="guest" <?php echo e(old('user_type')=='guest'?'selected':''); ?>>Guest</option>
...
<?php endif; ?><?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/users/create.blade.php ENDPATH**/ ?>