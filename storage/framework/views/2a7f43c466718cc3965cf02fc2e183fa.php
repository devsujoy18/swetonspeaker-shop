  ...
  border-color:#E6E6E6;
    ...
    <table width="680" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff" align="center">
      <tbody>
        ...
        <tr>
          <td align="left"><?php echo e($email_body); ?></td>
        </tr>
        <tr>
          <td> &nbsp; &nbsp;</td>
        </tr>
        ...
        <tr>
          <td align="left"><table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              ...
              <tr>
                <td valign="top" align="left">Shipping Method: Courier</td>
              ...
              <tr>
                <td colspan="4" align="left"><table width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody>
                    ...
                    <tr bgcolor="#E6E6E6">
                      <th width="50%" align="left" valign="top">Product</th>
                     
                      <th width="10%" align="left" valign="top">Qty</th>
                      <th width="20%" align="left" valign="top">Price</th>
                      <th width="20%" align="left" valign="top">Total</th>
                    </tr>
                  </tbody>
    ...
    </html><?php /**PATH /home/ace85084/public_html/shop.swetonspeakers.com/resources/views/emails/order_modified.blade.php ENDPATH**/ ?>