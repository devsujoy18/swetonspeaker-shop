        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm text-gray-700" aria-label="breadcrumb">
                <ol class="flex space-x-2">
                    ...
                    <li class="text-gray-800"><?php echo e($type == 'pro-loudspeaker' ? 'Pro Loudspeaker' : 'Home Loudspeaker'); ?></li>
                </ol>
            </nav>
        </div>
    </div>
...
[$__name, $__params] = $__split('category.type-product-component', ['type' => $type]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2842422793-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/type_category.blade.php ENDPATH**/ ?>