...
$__html = app('livewire')->mount($__name, $__params, 'lw-1459283389-0', $__slots ?? [], get_defined_vars());
                        ...
                        <div class="mt-6 space-y-4">
                            ...
                            <div class="flex items-center cursor-pointer border p-3">
                                ...
                                <label for="razorpay" class="flex items-center ml-2 text-sm font-medium text-gray-700 cursor-pointer">
                                    <img src="https://swetonspeakers.com/shop/public/image/razorpay.jpg" alt="Razorpay Logo" class="h-6 mr-2">
...
<?php endif; ?><?php /**PATH /home/ace85084/public_html/shop/resources/views/checkout.blade.php ENDPATH**/ ?>