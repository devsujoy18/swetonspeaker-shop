      ...
      <div class="p-4 border-b">
        <div class="flex gap-4 items-center">
          ...
          <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->attributes->shop_description): ?>
...
<?php /**PATH C:\xampp\htdocs\swetonspeaker-shop\resources\views/livewire/cart/icon-component.blade.php ENDPATH**/ ?>