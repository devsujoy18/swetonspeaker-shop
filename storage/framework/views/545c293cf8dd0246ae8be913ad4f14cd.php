        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm text-gray-700" aria-label="breadcrumb">
                <ol class="flex space-x-2">
                    ...
                    <li class="text-gray-800">Guest Checkout</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_name" name="billing_name" value="<?php echo e(old('billing_name')); ?>" placeholder="Enter Your Name" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="billing_email" name="billing_email" value="<?php echo e(old('billing_email')); ?>" placeholder="Enter Your Email" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_phone" name="billing_phone" value="<?php echo e(old('billing_phone')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="billing_zip" name="billing_zip" value="<?php echo e(old('billing_zip')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_locality" name="billing_locality" value="<?php echo e(old('billing_locality')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="billing_street" name="billing_street" value="<?php echo e(old('billing_street')); ?>" placeholder="Address" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_city" name="billing_city" value="<?php echo e(old('billing_city')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="billing_state" name="billing_state" value="<?php echo e(old('billing_state')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_landmark" name="billing_landmark" value="<?php echo e(old('billing_landmark')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    <label for="billing_alternate_phone" class="block text-sm font-medium text-gray-700 mb-1">Alternate Phone (Optional)</label>
                                    <input type="text" id="billing_alternate_phone" name="billing_alternate_phone" value="<?php echo e(old('billing_alternate_phone')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center mb-4">
                                <input id="sameAsBilling" name="shipping_same_as_billing" type="checkbox" class="h-4 w-4 text-blue-600 rounded-md border-gray-300 focus:ring-blue-500" value="1" <?php echo e(old('shipping_same_as_billing') ? 'checked' : ''); ?>>
                                <label for="sameAsBilling" class="ml-2 block text-sm font-medium text-gray-700">shipping to a same address?</label>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="shipping_name" class="block text-sm font-medium text-gray-700 mb-1">Name *</label>
                                    <input type="text" id="shipping_name" name="shipping_name" value="<?php echo e(old('shipping_name')); ?>" placeholder="Enter Your Name" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="shipping_email" name="shipping_email" value="<?php echo e(old('shipping_email')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_phone" name="shipping_phone" value="<?php echo e(old('shipping_phone')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="shipping_zip" name="shipping_zip" value="<?php echo e(session('checkout_postcode')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500" readonly>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_locality" name="shipping_locality" value="<?php echo e(old('shipping_locality')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="shipping_street" name="shipping_street" value="<?php echo e(old('shipping_street')); ?>" placeholder="Address (Area and Street)" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_city" name="shipping_city" value="<?php echo e(old('shipping_city')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="shipping_state" name="shipping_state" value="<?php echo e(old('shipping_state')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_landmark" name="shipping_landmark" value="<?php echo e(old('shipping_landmark')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    <label for="shippingAlternatePhone" class="block text-sm font-medium text-gray-700 mb-1">Alternate Phone (Optional)</label>
                                    <input type="text" id="shippingAlternatePhone" name="shipping_alternate_phone" value="<?php echo e(old('shipping_alternate_phone')); ?>" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                        </div>
                    </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3695416735-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/guest_checkout.blade.php ENDPATH**/ ?>