...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2611336138-0', $__key);
    ...
    <nav class="flex flex-col space-y-2 px-4 py-2 text-gray-800 text-base">
      ...
      <div x-data="{ openProduct: false }" class="border-b">
        ...
        <div x-show="openProduct" x-transition class="pl-4 pb-2">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proCategories->isNotEmpty()): ?>
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeCategories->isNotEmpty()): ?>
...
</header><?php /**PATH C:\xampp\htdocs\swetonspeaker-shop\resources\views/components/frontend/header.blade.php ENDPATH**/ ?>