        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm text-gray-700" aria-label="breadcrumb">
                <ol class="flex space-x-2">
                    ...
                    <li class="text-gray-800"><?php echo e($categorySlug); ?></li>
                </ol>
            </nav>
        </div>
    </div>
...
[$__name, $__params] = $__split('category.category-products-component', ['type' => $type,'categorySlug' => $categorySlug]);

$__html = app('livewire')->mount($__name, $__params, 'lw-3552562093-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/category_products.blade.php ENDPATH**/ ?>