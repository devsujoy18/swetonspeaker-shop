...
<div class="bg-white shadow sticky top-0 z-50">
    ...
    <!-- Navigation Panel -->
    <div class="site-header__nav-panel border-t">
                    ...
                    <div class="relative bg-red-700" style="width: 256px;">
                        ...
                        <div id="categoryDropdown" class="absolute left-0 w-64 bg-red-600 text-white font-semibold shadow-lg z-50 hidden peer-checked:block transition-all duration-300 ease-in-out">
                            <ul class="divide-y divide-red-500">
                                <?php if(isset($proCategories) && $proCategories->isNotEmpty()): ?>
                                        ...
                                        <div class="absolute top-0 left-full w-[1000px] bg-white text-black shadow-lg border border-gray-300 rounded-md hidden group-hover:grid grid-cols-4 gap-4 p-4 z-50">
                                            <?php $__currentLoopData = $proCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="border border-red-600 rounded-sm bg-white">
                                                    ...
                                                    <?php if(isset($category->products) && $category->products->isNotEmpty()): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-71837397-0', $__slots ?? [], get_defined_vars());
...
</header><?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/components/frontend/navbar.blade.php ENDPATH**/ ?>