                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($product->latest_order1_image): ?>
                                    <img src="<?php echo e(env('IMG_HOST')); ?>uploads/<?php echo e($product->latest_order1_image->path); ?>" style="height:120px;width: 120px;">
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($editingProductId === $product->id && $editingField === 'mrp'): ?>
                                    <input type="number" step="0.01" wire:model.blur="editedValue"
                                           wire:keydown.enter="saveField(<?php echo e($product->id); ?>)"
                                           wire:keydown.escape="cancelEdit"
                                           class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" />
                                    <button wire:click="saveField(<?php echo e($product->id); ?>)" class="mt-1 mr-1 px-2 py-1 bg-blue-500 text-white rounded text-xs">Save</button>
                                    <button wire:click="cancelEdit" class="mt-1 px-2 py-1 bg-gray-300 text-gray-700 rounded text-xs">Cancel</button>
                                <?php else: ?>
                                    <span wire:click="editField(<?php echo e($product->id); ?>, 'mrp', '<?php echo e($product->mrp); ?>')"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($editingProductId === $product->id && $editingField === 'price'): ?>
                                    <input type="number" step="0.01" wire:model.blur="editedValue"
                                           wire:keydown.enter="saveField(<?php echo e($product->id); ?>)"
                                           wire:keydown.escape="cancelEdit"
                                           class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" />
                                    ...
                                    <button wire:click="cancelEdit" class="mt-1 px-2 py-1 bg-gray-300 text-gray-700 rounded text-xs">Cancel</button>
                                <?php else: ?>
                                    <span wire:click="editField(<?php echo e($product->id); ?>, 'price', '<?php echo e($product->price); ?>')" class="group inline-flex items-center gap-1 cursor-pointer hover:bg-gray-100 rounded px-1 py-0.5 transition-colors duration-200" title="Click to edit Price">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($product->priceAttributes->isNotEmpty()): ?>
                                    <div class="space-y-2">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->priceAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pattribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center space-x-2">
                                                <span>
                                                    <?php echo e($pattribute->name); ?> : ₹<?php echo e(number_format($pattribute->mrp, 2)); ?> / ₹<?php echo e(number_format($pattribute->price, 2)); ?>

                                                </span>
                                                <button wire:click="openAttributeModal(<?php echo e($pattribute->id); ?>)" class="text-blue-600 hover:text-blue-900 transition-colors duration-200">
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <button wire:click="openAttributeModal(null, <?php echo e($product->id); ?>)" class="mt-2 px-3 py-1 bg-indigo-600 text-white rounded-md text-sm hover:bg-indigo-700 transition-colors duration-200">
                                    Add Attributes
                                </button>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($product->combinations): ?>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            <?php echo e($combination->name); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex flex-wrap gap-1 mb-2">
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $product->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <button
                                    wire:click="openTagModal(<?php echo e($product->id); ?>)"
                                    wire:loading.attr="disabled"
                                    wire:target="openTagModal(<?php echo e($product->id); ?>)"
                                ...
                                >
                                    <span wire:loading.remove wire:target="openTagModal(<?php echo e($product->id); ?>)">
                                        Map Tags
                                    </span>
                                    <span wire:loading wire:target="openTagModal(<?php echo e($product->id); ?>)">
                                        Opening...
                                    </span>
                                </button>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($editingProductId === $product->id && $editingField === 'shop_status'): ?>
                                    <select wire:model.blur="editedValue"
                                            wire:change="saveField(<?php echo e($product->id); ?>)"
                                            wire:keydown.escape="cancelEdit"
                                    ...
                                    <button wire:click="cancelEdit" class="mt-1 px-2 py-1 bg-gray-300 text-gray-700 rounded text-xs">Cancel</button>
                                <?php else: ?>
                                    <span wire:click="editField(<?php echo e($product->id); ?>, 'shop_status', '<?php echo e($product->shop_status); ?>')" class="group inline-flex items-center gap-1 cursor-pointer hover:bg-gray-100 rounded px-1 py-0.5 transition-colors duration-200" title="Click to edit Shop Status">
                                        <?php echo e($this->getShopStatusText($product->shop_status)); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($editingProductId === $product->id && $editingField === 'shop_order_no'): ?>
                                    ...
                                    <button wire:click="cancelEdit" class="mt-1 px-2 py-1 bg-gray-300 text-gray-700 rounded text-xs">Cancel</button>
                                <?php else: ?>
                                    <span wire:click="editField(<?php echo e($product->id); ?>, 'shop_order_no', '<?php echo e($product->shop_order_no); ?>')" class="group inline-flex items-center gap-1 cursor-pointer hover:bg-gray-100 rounded px-1 py-0.5 transition-colors duration-200" title="Click to edit Shop Order No">
                                        <?php echo e($product->shop_order_no); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!--[if BLOCK]><![endif]--><?php if($editingProductId === $product->id && $editingField === 'shop_description'): ?>
                                    ...
                                    <button wire:click="cancelEdit" class="mt-1 px-2 py-1 bg-gray-300 text-gray-700 rounded text-xs">Cancel</button>
                                <?php else: ?>
                                    <span wire:click="editField(<?php echo e($product->id); ?>, 'shop_description', '<?php echo e($product->shop_description); ?>')" class="group inline-flex items-center gap-1 cursor-pointer hover:bg-gray-100 rounded px-1 py-0.5 transition-colors duration-200" title="Click to edit Price">
                                        <?php echo e($product->shop_description); ?>
                        ...
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                                    <?php echo e($editingAttributeId ? 'Edit Attribute' : 'Add New Attribute'); ?>
                                ...
                                <div class="mt-2">
                                    <form wire:submit.prevent="saveAttribute">
                                        <div class="mb-4">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['attributeName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['attributeMrp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['attributePrice'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($editingAttributeId): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showTagModal): ?>
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <form wire:submit.prevent="saveTagMapping" class="mt-4">
                            <div class="max-h-72 overflow-y-auto border border-gray-200 rounded-md p-3 space-y-2">
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $availableTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <label class="flex items-center gap-2">
                                        <input
                                            type="checkbox"
                                            wire:model="selectedTags"
                                            value="<?php echo e($tagOption->id); ?>"
                                            class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500"
                                        >
                                        <span class="text-sm text-gray-700"><?php echo e($tagOption->title); ?></span>
                                    </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedTags.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/livewire/products/manage-component.blade.php ENDPATH**/ ?>