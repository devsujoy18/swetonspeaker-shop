      ...
      <!-- MOBILE CARD VIEW (Visible below md breakpoint) -->
        <div id="mobile-card-view" class="md:hidden space-y-4 mb-5">
            ...
            <div class="bg-white p-5 rounded-xl shadow-lg relative border border-gray-100">
                ...
                <button wire:click="removeItem('<?php echo e($item->id); ?>')" wire:confirm="Are you sure you want to delete this item?" class="absolute top-3 right-3 text-red-400 hover:text-red-500 text-2xl transition duration-150 rounded-full p-1 leading-none">
                    <i class="fas fa-times"></i>
                </button>

                <!-- Product Title and Options (Matching uploaded image) -->
                <div class="text-center pb-4 mb-4">
                    <img src="<?php echo e($item->attributes->image); ?>" alt="<?php echo e($item->name); ?>" style="margin:0 auto; display:table" class="w-80 object-contain mb-5">
                    <h3 class="font-bold text-gray-800 text-lg"><?php echo e($item->name); ?></h3>
                    <!--[if BLOCK]><![endif]--><?php if($item->attributes->shop_description): ?>
                                                <p class="text-sm text-gray-500">(<?php echo e($item->attributes->shop_description); ?>)</p>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center text-base">
                        ...
                        <span class="font-semibold text-gray-800">₹ <?php echo e(number_format($item->price, 2)); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between items-center text-base">
                        ...
                        <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                            <button 
                                                wire:click="decrementQuantity('<?php echo e($item->id); ?>')" 
                                                wire:loading.attr="disabled"
                                                wire:target="decrementQuantity(<?php echo e($item->id); ?>)"
                                            ...
                                            <button 
                                                wire:click="incrementQuantity('<?php echo e($item->id); ?>')" 
                                                wire:loading.attr="disabled"
                                                wire:target="incrementQuantity(<?php echo e($item->id); ?>)"
                                                class="px-3 py-1 text-gray-600 hover:bg-gray-100 disabled:opacity-50"
                                            >
                                                +
                                            </button>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-gray-100 text-base">
                        ...
                        <!-- Using ₹ 915 to match the visual in the uploaded image -->
                        <span class="font-bold text-gray-800">₹ <?php echo e(number_format(($item->price * $item->quantity), 2)); ?></span>
                    </div>
                </div>
           ...
           <div class="flex justify-end space-x-4 mt-6">
                <a href="<?php echo e(url('/')); ?>" class="px-6 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition">
                    Continue Shopping
                </a>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr wire:key="cart-item-<?php echo e($item->id); ?>">
                                    <td class="px-6 py-4">
                                        <div class="relative">
                                            <img src="<?php echo e($item->attributes->image); ?>" alt="<?php echo e($item->name); ?>" class="w-20 h-20 object-contain">
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div>
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="font-medium text-gray-800">₹ <?php echo e(number_format($item->price, 2)); ?></span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="font-medium text-gray-800">₹ <?php echo e(number_format(($item->price * $item->quantity), 2)); ?></span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <button wire:click="removeItem('<?php echo e($item->id); ?>')" wire:confirm="Are you sure you want to delete this item?" class="text-red-500 hover:text-red-700">
                                            <i class="fas fa-times"></i>
                                        </button>
                                    </td>
                                </tr>
            ...
            <div class="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="flex justify-between text-sm font-semibold">
                        ...
                        <span class="text-gray-800">₹ <?php echo e(number_format($total, 2)); ?></span>
                    </div>
                </div>

                <!--[if BLOCK]><![endif]--><?php if($total < $minimumCartAmount): ?>
                    <div class="bg-red-50 border border-red-200 rounded p-3 mb-4">
                        <p class="text-red-600 text-sm">Minimum Total Order Value should be Rs.<?php echo e($minimumCartAmount); ?></p>
                    </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <button
                    ...
                    <?php if(!$cartEnabled || $total < $minimumCartAmount): ?> disabled <?php endif; ?>
                >
                ...
                <div>
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2 space-y-4">
                            ...
                            <a href="<?php echo e(route('guest.checkout')); ?>" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto sm:text-sm">
                                Continue as Guest
                            </a>
                            <a href="<?php echo e(route('checkout')); ?>" class="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto sm:text-sm">
                                Login or Register
                            </a>
                        </div>
                    </div>
...
</div><?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/livewire/cart/details-component.blade.php ENDPATH**/ ?>