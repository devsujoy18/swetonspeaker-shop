        ...
        <tr>
            <td align="center" style="padding: 20px;">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; padding: 30px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
                    <tr>
                        <td>
                            <h2 style="color: #333;">Hello <?php echo e($user->name); ?>, 🎉</h2>
                            ...
                            <p style="margin-top: 30px;">
                                <a href="<?php echo e(url('/dashboard')); ?>" style="background-color: #4f46e5; color: #ffffff; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: bold;">
                                    Go to Dashboard
                                </a>
                            </p>
...
<?php /**PATH /home/ace85084/public_html/shop.ace.sminfomedia.com/resources/views/emails/user_welcome.blade.php ENDPATH**/ ?>