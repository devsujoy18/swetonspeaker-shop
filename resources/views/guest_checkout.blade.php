                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_name" name="billing_name" value="{{ old('billing_name') }}" placeholder="Enter Your Name" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('billing_name')
                                ...
                                <div>
                                    ...
                                    <input type="email" id="billing_email" name="billing_email" value="{{ old('billing_email') }}" placeholder="Enter Your Email" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('billing_email')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_phone" name="billing_phone" value="{{ old('billing_phone') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('billing_phone')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="billing_zip" name="billing_zip" value="{{ old('billing_zip') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('billing_zip')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_locality" name="billing_locality" value="{{ old('billing_locality') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="billing_street" name="billing_street" value="{{ old('billing_street') }}" placeholder="Address" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_city" name="billing_city" value="{{ old('billing_city') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('billing_city')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="billing_state" name="billing_state" value="{{ old('billing_state') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('billing_state')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="billing_landmark" name="billing_landmark" value="{{ old('billing_landmark') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="billing_alternate_phone" name="billing_alternate_phone" value="{{ old('billing_alternate_phone') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center mb-4">
                                <input id="sameAsBilling" name="shipping_same_as_billing" type="checkbox" class="h-4 w-4 text-blue-600 rounded-md border-gray-300 focus:ring-blue-500" value="1" {{ old('shipping_same_as_billing') ? 'checked' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_name" name="shipping_name" value="{{ old('shipping_name') }}" placeholder="Enter Your Name" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('shipping_name')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="email" id="shipping_email" name="shipping_email" value="{{ old('shipping_email') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_phone" name="shipping_phone" value="{{ old('shipping_phone') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="shipping_zip" name="shipping_zip" value="{{ session('checkout_postcode') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500" readonly>
                                    @error('shipping_zip')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_locality" name="shipping_locality" value="{{ old('shipping_locality') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('shipping_locality')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    <label for="shipping_street" class="block text-sm font-medium text-gray-700 mb-1">Street Address *</label>
                                    <input type="text" id="shipping_street" name="shipping_street" value="{{ old('shipping_street') }}" placeholder="Address (Area and Street)" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_city" name="shipping_city" value="{{ old('shipping_city') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                    @error('shipping_city')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="shipping_state" name="shipping_state" value="{{ old('shipping_state') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="shipping_landmark" name="shipping_landmark" value="{{ old('shipping_landmark') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="shippingAlternatePhone" name="shipping_alternate_phone" value="{{ old('shipping_alternate_phone') }}" class="mt-1 block w-full rounded-md border border-gray-300 p-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                        </div>
                    </div>
