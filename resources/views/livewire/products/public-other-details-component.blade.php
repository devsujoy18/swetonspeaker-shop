                        ...
                        <div class="bg-gray-50 rounded-lg overflow-hidden">
                            ...
                            <div class="p-5 space-y-2 text-sm">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500">{{ $specification->specification->name }}</span>
                                    <span class="font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded-md text-right">{{ $specification->value }}</span>
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-gray-50 rounded-lg overflow-hidden">
                            ...
                            <div class="p-5 space-y-2 text-sm">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500">{{ $tsparameter->tsparameter->name }}</span>
                                    <span class="font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded-md text-right">{{ $tsparameter->value }}</span>
                                </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="space-y-8">
                        @if($firstCombination->productmountinginfos)
                         <div class="bg-gray-50 rounded-lg overflow-hidden">
                            ...
                            <div class="p-5 space-y-2 text-sm">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500">{{ $mountinginfo->mountinginfo->name }}</span>
                                    <span class="font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded-md">{{ $mountinginfo->value }}</span>
                                </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg overflow-hidden">
                            ...
                            <div class="p-5 space-y-2 text-sm">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-500">{{ $reconkit->reconkit->name }}</span>
                                    <span class="font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded-md">{{ $reconkit->value }}</span>
                                </div>
                                 @endforeach
                            </div>
                        </div>
