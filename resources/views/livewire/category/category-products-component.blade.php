<div class="container mx-auto px-4">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        <livewire:category.listsidebar-component :categorySlug="$categorySlug"/>
                ...
                <div class="bg-white px-4 py-4 rounded-lg shadow-md mb-4 border border-gray-200 md:hidden">
                    <div class="py-4" x-cloak x-data="{ open: false }">
                        <div class="flex justify-between items-center">
                            ...
                            <div>Total Product Total Products {{ $this->products->count() }}</div>
                        </div>
                        <div
                            x-show="open"
            ...
            <div class="bg-white px-3 py-3 rounded-2xl shadow-md mb-8 border border-gray-200 hidden md:block">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <span class="text-gray-800 text-sm font-medium">Total Products: <strong class="text-blue-600">Total Products {{ $this->products->count() }}</strong></span>
                  </div>
                    ...
                    @foreach($this->products as $product)
                        ...
                        x-init="$nextTick(() => { if ($refs.img?.complete) imgLoading = false })" >
                            ...
                            <div class="mt-3 text-center">
                                <a href="{{ route('product.details', [ $type, $categorySlug, $product->slug ] ) }}" class="bg-gray-800 hover:bg-gray-700 text-white px-6 py-2 rounded text-sm font-semibold whitespace-nowrap">
                                    View Details
                                </a>
                            </div>
